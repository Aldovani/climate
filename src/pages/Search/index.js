...
export default function Search() {
  ...
  async function handleSearch() {
    ...
    // weather?key=2152c77f&city_name=Campinas,SP
  ...
  if (city) {
    return (
      ...
      <SafeAreaView style={styles.container}>
        <TouchableOpacity style={styles.backButton} onPress={() => { navegation.navigate("Home") }}>
          <Feather
            name="chevron-left"
            size={32}
            color="#000"
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {erro && <Text style={{ fontSize: 18, marginTop: 25 }}>{erro}</Text>}
